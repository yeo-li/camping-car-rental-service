...
public class RepairRecordFetchServiceTest {
	...
	public static void main(String[] args) {
		...
		service = new RepairRecordFetchService(new CampingCarRepository(dc.getConnection()),
				new ExternalRepairRecordRepository(DBConnection.getConnection()),
				new ExternalRepairShopRepository(dc.getConnection()),
				new InternalRepairRecordRepository(dc.getConnection()), new PartRepository(dc.getConnection()));
