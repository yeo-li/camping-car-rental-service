    ...
    public InternalRepairRecordInsertPanel() {
        ...
        saveButton.addActionListener(e -> {
            try {
                ...
                Date repairDate = Date.valueOf(repairDateField.getText().trim());
                int duration = Integer.parseInt(durationField.getText().trim());
                int employeeId = Integer.parseInt(employeeIdField.getText().trim());

                InternalRepairRecord record = ac.dataInsertService().creatInternalRepairRecord(
                        carId, partId, repairDate, duration, employeeId
                );
