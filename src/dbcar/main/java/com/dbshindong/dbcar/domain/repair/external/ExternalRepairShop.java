...
public class ExternalRepairShop {
	...
	public ExternalRepairShop(int shop_id, String name, String address, String phone, String manager_name, String manager_email) {
	...
	private void validate(int shop_id, String name, String address, String phone, String manager_name, String manager_email) {
